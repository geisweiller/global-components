...
const meta = {
  ...
  argTypes: {
    index: {
      control: "number",
      description: "The index will be the number provided to be displayed on this simple counter."
    }
  }
